CREATE DATABASE  IF NOT EXISTS `yodel_guanzon` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `yodel_guanzon`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: yodel_guanzon
-- ------------------------------------------------------
...
CREATE TABLE `clients` (
  ...
  UNIQUE KEY `idclientele_UNIQUE` (`ClientId`),
  KEY `fk_clients_stylists_idx` (`StylistId`)
...
-- Dump completed on 2023-01-02  6:59:50
